...
def get_model_training_dir() -> str:
    ...
    try:
        ...
        try:
            ...
            raise FileNotFoundError(f'Unable to locate directory \'{dir_name}\' in ' +
                                    f'working directory: \'{os.getcwd()}\' or its parent.\n' +
                                    f'Please initiate training from the project root directory.')
...
def get_dataset_dir() -> str:
    ...
    try:
        ...
        raise FileNotFoundError(f'Unable to locate trainind data directory \'{data_set_dir_name}\' in \'{training_data_dir}\'.\n' +
                                f'Model cannot be trained without data.\n' +
                                f'Please download the training data from https://magenta.tensorflow.org/datasets/e-gmd ' +
